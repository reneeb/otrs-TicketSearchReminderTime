...
# ---
            ...
            TicketPendingTimeNewerDate TicketPendingTimeOlderDate
            )
# ---
            )
        {
...
#                    if ( $Key =~ /^(Ticket|Article)(Create|Change|Close|Escalation)/ ) {
                    if ( $Key =~ /^(Ticket|Article)(Create|Change|Close|Escalation|Pending)/ ) {
# ---
...
# ---
            {
                ...
                Value => Translatable('Ticket Pending Time (before/after)'),
            },
            {
                Key   => 'TicketPendingTimeSlot',
                Value => Translatable('Ticket Pending Time (between)'),
            },
# ---
        );
